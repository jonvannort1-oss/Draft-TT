        ...
        <section className="py-10 md:py-10 bg-background">
            <div className="container px-4 mx-auto">
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    >
                        <Card className="bg-background border-border h-full relative overflow-hidden group hover:border-red-600/50 transition-colors">
                            ...
                            <CardHeader>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-red-600">The Reality</h3>
                                </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="p-4 rounded-lg bg-red-600/5 border border-red-600/10">
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3 text-sm text-gray-400">
                                            <PhoneMissed className="w-5 h-5 text-red-600 shrink-0" />
